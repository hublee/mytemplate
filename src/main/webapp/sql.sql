...
insert  into `sys_log`(`id`,`type`,`create_by`,`create_date`,`remote_addr`,`user_agent`,`request_uri`,`method`,`params`,`exception`,`description`) values (11,'2','2,超级管理员','2015-02-28 00:43:12','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36','/mytemplate/test/area/save','POST','[参数1，类型:SysArea，值:{\"id\":38,\"parentId\":0,\"icon\":\"\",\"parentIds\":\"0,\",\"oldParentIds\":\"\",\"name\":\"asd\",\"remarks\":\"\",\"code\":\"adsd\",\"createDate\":1425055392163,\"type\":\"1\",\"createBy\":\"2,超级管理员\",\"updateDate\":1425055392163,\"delFlag\":\"0\"}]','org.springframework.jdbc.BadSqlGrammarException: \r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'a\' in \'field list\'\r\n### The error may exist in file [C:\\apache-tomcat-7.0.54\\webapps\\mytemplate\\WEB-INF\\classes\\com\\template\\web\\sys\\mapper\\SysAreaMapper.xml]\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: select a from sys_area\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'a\' in \'field list\'\n; bad SQL grammar []; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'a\' in \'field list\'',NULL);
